...
export default function Login() {
  ...
  return (
    ...
    <div className="h-[100dvh] w-full overflow-y-auto overflow-x-hidden bg-transparent font-sans relative safe-pb">
      ...
      {/* ✅ ส่วน SEO */}
      <Helmet>
        <title>Soulis - พื้นที่ปลอดภัยสำหรับใจคุณ (นิรนาม)</title>
        <meta
          name="description"
          content="เข้าสู่ระบบ Soulis เว็บไซต์ระบายความในใจและหาเพื่อนรับฟังแบบนิรนาม ปลอดภัย เป็นกันเอง และใช้งานฟรี"
        />
      ...
      <div className="min-h-full w-full flex items-center justify-center p-4 py-10">
        ...
        <div className="bg-soulis-800/60 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[2rem] shadow-2xl w-full max-w-md relative z-10 flex flex-col items-center gap-8 mb-10 text-center animate-float">
          ...
          {/* 🔥 [SEO UPDATE] เพิ่มส่วน Footer Text + Links เพื่อให้ Bot อ่านเจอและ Index หน้าอื่นๆ */}
          <div className="mt-8 pt-8 border-t border-white/10 text-center space-y-4">
            <div className="text-gray-400 text-sm font-light space-y-2 opacity-80 hover:opacity-100 transition-opacity">
              <h2 className="text-white font-semibold text-base">Soulis คืออะไร?</h2>
              <p className="leading-relaxed">
                Soulis คือพื้นที่สำหรับ <strong>ระบายความในใจ</strong> และ <strong>หาเพื่อนคุยแบบนิรนาม (Anonymous)</strong> 
                ที่ปลอดภัยที่สุด เราช่วยให้คุณได้พูดคุย ปรึกษาปัญหาชีวิต หรือรับฟังเรื่องราวจากเพื่อนใหม่ 
                โดยไม่ต้องเปิดเผยชื่อจริง
              </p>
            </div>

            <div className="flex flex-wrap justify-center gap-4 text-xs text-soulis-300">
               {/* ใช้ Link Component ของ React Router หรือ a href ปกติก็ได้ แต่สำหรับ SEO a href ชัวร์สุดในบางบริบท แต่ใน SPA ใช้ Link ก็ได้ครับ */}
              <a href="/about" className="hover:text-white transition underline">เกี่ยวกับเรา</a>
              <a href="/instruction" className="hover:text-white transition underline">คู่มือการใช้งาน</a>
              <a href="/privacy-policy" className="hover:text-white transition underline">นโยบายความเป็นส่วนตัว</a>
            </div>

            <p className="text-[10px] text-gray-600">
              Keywords: หาเพื่อนคุย, ระบายความเครียด, ที่ปรึกษาปัญหาชีวิต, คุยกับคนแปลกหน้า, สุขภาพจิต, นิรนาม
            </p>
          </div>
          ...
          <div className="bg-soulis-800 border border-soulis-500/30 text-white w-full max-w-lg rounded-3xl shadow-2xl p-8 relative flex flex-col gap-4">
            ...
            <div className="text-sm text-gray-300 space-y-4 leading-relaxed bg-black/20 p-4 rounded-xl border border-white/5 max-h-[40vh] overflow-y-auto custom-scrollbar">
              ...
              <ul className="list-disc pl-5 space-y-2 text-gray-400">
                ...
                {/* 🔥 เพิ่มข้อความกรณีฉุกเฉินร้ายแรง */}
                <li className="bg-red-500/10 border border-red-500/30 p-2 rounded-lg text-red-200">
                    <span className="text-red-400 font-bold">⚠️ กรณีฉุกเฉิน:</span> หากท่านมีภาวะซึมเศร้ารุนแรงหรือมีความคิดทำร้ายตัวเอง กรุณาติดต่อสายด่วนสุขภาพจิต 1323 หรือ 1669 ทันที (ระบบนี้เป็นเพียงเพื่อนรับฟังเบื้องต้นเท่านั้น)
                </li>
