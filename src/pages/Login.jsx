    ...
    <div className="h-[100dvh] w-full overflow-y-auto overflow-x-hidden bg-transparent font-sans relative safe-pb">
      ...
      <div className="min-h-full w-full flex items-center justify-center p-4 py-10">
        ...
        <div className="bg-soulis-800/60 backdrop-blur-xl border border-white/10 p-8 md:p-12 rounded-[2rem] shadow-2xl w-full max-w-md relative z-10 flex flex-col items-center gap-8 mb-10 text-center animate-float">
          ...
          {/* 🔥 [SEO UPDATE] คงเหลือไว้แค่ Text Description กับ Keywords (เอาลิงก์ออกแล้ว) */}
          <div className="mt-8 pt-8 border-t border-white/10 text-center space-y-4">
            <div className="text-gray-400 text-sm font-light space-y-2 opacity-80 hover:opacity-100 transition-opacity">
              ...
              <p className="leading-relaxed">
                Soulis คือพื้นที่สำหรับ <strong>ระบายความในใจ</strong> และ <strong>หาเพื่อนคุยแบบไม่ระบุตัวตน (Anonymous)</strong> 
                ที่ปลอดภัยที่สุด เราช่วยให้คุณได้พูดคุย ปรึกษาปัญหาชีวิต หรือรับฟังเรื่องราวจากเพื่อนใหม่ 
                โดยไม่ต้องเปิดเผยชื่อจริง
              </p>
            </div>

            {/* ❌ เอาลิงก์ 3 อันออกไปแล้วตามคำขอ */}

            <p className="text-[10px] text-gray-600">
              Keywords: หาเพื่อนคุย, ระบายความเครียด, ที่ปรึกษาปัญหาชีวิต, คุยกับคนแปลกหน้า, สุขภาพจิต, ไม่ระบุตัวตน
            </p>
          </div>
