...
export default function About() {
  ...
  return (
    ...
    <div className="fixed inset-0 z-10 bg-transparent h-[100dvh] w-full overflow-y-auto overflow-x-hidden font-sans">
      ...
      {/* ✅ ส่วน SEO: ปรับปรุง Title และ Description เพื่อดึงคนค้นหา */}
      <Helmet>
        <title>เกี่ยวกับ Soulis - เว็บหาเพื่อนคุยและระบายความในใจ (นิรนาม)</title>
        <meta 
          name="description" 
          content="Soulis คือพื้นที่ปลอดภัยสำหรับคนที่ต้องการระบายความในใจ หรือหาเพื่อนรับฟังปัญหาชีวิต แบบนิรนาม (Anonymous) ปลอดภัย ใช้งานฟรี ไม่ต้องโหลดแอป" 
        />
        <link rel="canonical" href="https://soulis.in.th/about" />
        <meta property="og:title" content="เกี่ยวกับเรา - Soulis เว็บหาเพื่อนคุย" />
        <meta property="og:description" content="พื้นที่ปลอดภัยสำหรับระบายความในใจแบบนิรนาม" />
